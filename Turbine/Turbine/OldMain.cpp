...
//  classname.lpszClassName="SpinOut";
...
//  CreateWindowEx(NULL, "SpinOut", "SpinOut - OpenGL Ride Assignment", WS_OVERLAPPEDWINDOW|WS_VISIBLE, offx, offy, width, height, NULL, NULL, hInstance, NULL);
//
